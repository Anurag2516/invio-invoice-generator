  ...
  return (
      <div className="flex justify-between gap-6 mt-6">
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <textarea
            {...register("notes")}
            className="border border-stone-200 rounded-lg px-3.5 py-3 text-sm text-stone-800 placeholder:text-stone-400 resize-y min-h-55 outline-none w-full hover:border-stone-400 focus:border-green-500 focus:ring-2 focus:ring-green-500/10"
