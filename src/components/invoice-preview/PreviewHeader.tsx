...
const PreviewHeader = ({
  ...
  return (
    <div className="flex justify-between items-start border-b-2 border-stone-400 bg-ink pb-4 sm:pb-6 mb-4 sm:mb-6 px-4 sm:px-8 py-6 sm:py-14 gap-2">
      ...
      <div className="flex flex-col gap-1.5 sm:gap-2 text-[11px] sm:text-sm text-stone">
        <p className="font-normal text-[#a89e92] bg-[#ffffff14] w-fit px-1.5 sm:px-2 py-0.5 sm:py-1 border border-[#ffffff1a] rounded font-numbers">
          #{invoiceNumber}
        </p>
        <p className="font-normal">
          ISSUE DATE
          <span className="font-normal text-[#c4baae] pl-1.5 sm:pl-3 font-numbers">
